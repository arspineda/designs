...
public class diagonal extends PApplet {
...
public void setup(){
  ...
  spacingCol = PApplet.parseInt(map(1,0,NUM_COLS+1,0,width));
  spacingRow = PApplet.parseInt(map(1,0,NUM_ROWS+1,0,height));
...
public void resetGrid(){
  ...
  prevRow = PApplet.parseInt(random(0,NUM_ROWS));
  prevCol = PApplet.parseInt(random(0,NUM_COLS));
...
//Next, we start at a point and visit vertices
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "diagonal" };
    if (passedArgs != null) {
